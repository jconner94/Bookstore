...
@WebServlet(name = "sendPromotionServlet", value ="/send-promotion-servlet")
public class SendPromotionServlet extends HttpServlet implements AdminInterface {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        if(adminCheck(request)) {
            ...
            if (promo == null) {
                ...
                try {
                    promoDao.updatePromoSendStatus(promoCode);
                } catch (ClassNotFoundException e) {
                    e.printStackTrace();
                }
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("/sendPromotion.jsp");
                dispatcher.forward(request, response);
            }
        } else {
